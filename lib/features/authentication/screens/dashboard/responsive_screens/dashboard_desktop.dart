        ...
        child: Row(
          children: [
              ...
              child: Card(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(p.fullNameformated, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            ...
            Expanded(
              ...
              child: Column(
                children: [
                  CircleAvatar(radius: 40, child: Text(p.firstName.isNotEmpty ? p.firstName[0] : '?')),
                  const SizedBox(height: 12),
                  Wrap(
                    spacing: 8,
                    children: [
                      if (p.canManageUsers) Chip(label: const Text('Users')),
                      if (p.canManageFinances) Chip(label: const Text('Finances')),
                      if (p.canManageAcademics) Chip(label: const Text('Academics')),
                    ],
                  ),
                ],
              ),
