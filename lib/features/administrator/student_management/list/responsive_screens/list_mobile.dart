// lib/features/administrator/enrollments/responsive_screens/enrollments_mobile.dart
...
class EnrollmentsMobileScreen extends StatelessWidget {
  const EnrollmentsMobileScreen({super.key});
