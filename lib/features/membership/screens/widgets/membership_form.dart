...
class SchoolMembershipForm extends StatefulWidget {
  ...
  @override
  State<SchoolMembershipForm> createState() => _SchoolOrgFormDialogState();
}

class _SchoolOrgFormDialogState extends State<SchoolMembershipForm> {
