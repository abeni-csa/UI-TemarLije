...
class TemarLijeRoundedContainer extends StatelessWidget {
  ...
  const TemarLijeRoundedContainer({
    super.key,
    this.child,
    this.width,
    this.height,
    ...
    this.padding = const EdgeInsets.all(TemarLijeSizes.md),
    this.borderColor = TemarLijeColors.borderPrimary,
    this.radius = TemarLijeSizes.cardRadiusLg,
    this.backgroundColor = TemarLijeColors.white,
    this.onTap,
  });
