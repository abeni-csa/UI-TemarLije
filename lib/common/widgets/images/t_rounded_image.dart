...
import 'package:ui_temarlije/common/widgets/shimmers/shimmer.dart';
import 'package:ui_temarlije/utils/constants/sizes.dart';
import 'package:ui_temarlije/utils/constants/enums.dart';

class TemarLijeRoundedImage extends StatelessWidget {
  const TemarLijeRoundedImage({
    ...
    this.borderRadius = TemarLijeSizes.md,
  });
    ...
    if (image != null) {
      ...
      return CachedNetworkImage(
        ...
        progressIndicatorBuilder: (context, url, downloadProgress) =>
            TemarLijeShimmerEffect(width: width, height: height),
      );
    } else {
